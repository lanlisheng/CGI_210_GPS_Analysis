...
protected:
    ...
    touchgfx::TextAreaWithOneWildcard East_Speed;
    touchgfx::TextAreaWithOneWildcard North_Speed;
    touchgfx::TextAreaWithOneWildcard Celestial_Speed;
    touchgfx::TextAreaWithOneWildcard Vehicle_Speed;
    ...
    static const uint16_t EAST_SPEED_SIZE = 10;
    touchgfx::Unicode::UnicodeChar East_SpeedBuffer[EAST_SPEED_SIZE];
    static const uint16_t NORTH_SPEED_SIZE = 10;
    touchgfx::Unicode::UnicodeChar North_SpeedBuffer[NORTH_SPEED_SIZE];
    static const uint16_t CELESTIAL_SPEED_SIZE = 10;
    touchgfx::Unicode::UnicodeChar Celestial_SpeedBuffer[CELESTIAL_SPEED_SIZE];
    static const uint16_t VEHICLE_SPEED_SIZE = 10;
    touchgfx::Unicode::UnicodeChar Vehicle_SpeedBuffer[VEHICLE_SPEED_SIZE];
